...
switch($which_table) {
    ...
    case "contract-fill":
        $insert_query = "insert into contract values (\"".$_POST["employee_code"]."\",\"".$_POST["start_date"]."\",\"".$_POST["end_date"]."\",\"".$_POST["renewal"]."\")";
        break;
    
    case "promotion-fill":
        $insert_query = "insert into promotion values (\"".$_POST["employee_code"]."\",\"".$_POST["type-promotion"]."\",\"".$_POST["promoition-date"]."\",\"".$_POST["details-promotion"]."\")";
        break;
    ...
    case "personal-fill":
        $insert_query = "insert into salary_allowances values (\"".$_POST["employee_code"]."\",\"".$_POST["title"]."\",\"".$_POST["name"]."\",\"".$_POST["sex"]."\",\"".$_POST["dob"]."\",\"".$_POST["age"]."\",\"".$_POST["staff_classification"]."\",\"".$_POST["designation"]."\",\"".$_POST["reporting_manager"]."\",\"".$_POST["department"]."\",\"".$_POST["location"]."\",\"".$_POST["date_of_joining"]."\",\"".$_POST["diversity_status"]."\",\"".$_POST["educational_qualification"]."\",\"".$_POST["education_details"]."\",\"".$_POST["professional_qualification"]."\",\"".$_POST["present_address"]."\",\"".$_POST["permanent_address"]."\",\"".$_POST["city"]."\",\"".$_POST["state"]."\",\"".$_POST["phone"]."\",\"".$_POST["emergency_no"]."\",\"".$_POST["email"]."\",\"".$_POST["marital_status"]."\",\"".$_POST["father_husband_name"]."\",\"".$_POST["father_husband"]."\",\"".$_POST["nominee_name"]."\",\"".$_POST["relationship"]."\",\"".$_POST["bank_name"]."\",\"".$_POST["ifsc_code"]."\",\"".$_POST["acc_no"]."\",\"".$_POST["aadhar_no"]."\",\"".$_POST["pan_no"]."\",\"".$_POST["passport_no"]."\",\"".$_POST["pf_no"]."\",\"".$_POST["uan_no"]."\",\"".$_POST["last_working_day"]."\",\"".$_POST["status"]."\")";
        break;
